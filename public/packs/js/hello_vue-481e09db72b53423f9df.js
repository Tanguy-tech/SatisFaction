...
document.addEventListener('turbolinks:load', function () {
  vue__WEBPACK_IMPORTED_MODULE_0__["default"].http.headers.common['X-CSRF-Token'] = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
  var element = document.getElementById("survey-form");

  if (element != null) {
    var survey = JSON.parse(element.dataset.survey);
    var question_attributes = JSON.parse(element.dataset.questionAttributes);
    question_attributes.forEach(function (question) {
      question._destroy = null;
    });
    survey.question_attributes = question_attributes;
    var app = new vue__WEBPACK_IMPORTED_MODULE_0__["default"]({
      el: element,
      mixins: [vue_turbolinks__WEBPACK_IMPORTED_MODULE_1__["default"]],
      data: function data() {
        return {
          survey: survey
        };
      ...
      methods: {
        addQuestion: function addQuestion() {
          survey.question_attributes.push({
            id: null,
            number: "",
            content: "",
            _destroy: null
...
/******/ });
//# sourceMappingURL=hello_vue-481e09db72b53423f9df.js.map